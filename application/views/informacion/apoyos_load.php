...
<div class="row">
    <div class="col-md-12">
      <?php 
        if($totalApoyos->num_rows()>0){
          echo "<p class='text-left'>Total entregado:</p>";
          foreach($totalApoyos->result() as $apoyos){ ?>
          <b><p class="text-left"><?=$apoyos->unidad?>: <?=$apoyos->total?></p></b>
        <?  }
        }
      ?>
...
<script>
    $(document).ready(function() { 
        ...
        $.ajax({
            ...
            url: "<?=base_url()?>Informacion/loadApoyosJson",
