      ...
      <div class="modal-body">
        ...
        <div class="col-md-12 text-center" id="divdatos" style="display: none">
          <table class="table">
            ...
            <tr>
              <td>Sección: <b id="seccionB"></b></td>
              <td>Comunidad: <b id="comunidadB"></b></td>
            </tr>
            <tr>
...
<script>
    $(document).ready(function() { 
        ...
        $.ajax({
            ...
            url: "<?=base_url()?>Informacion/loadTenenciasJson",
      ...
      $.ajax({
          ...
          success: function (xhr){
              if(xhr){
                  ...
                  $('#seccionB').text(data.seccion);
                  $('#comunidadB').text(data.comunidad);
