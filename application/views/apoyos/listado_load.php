        ...
        <div class="col-md-12 text-center" id="divdatos" style="display: none">
          ...
          <b><p id="descripcion"></p></b>
            ...
            <div class="form-group" id="divEntregado">
              <table class="table"> 
                <tr>
                  <td>Fecha de autorización: <br><b id="fechaAu"></b></td>
                  <td>Autorizo: <br><b id="autorizo"></b></td>
                  <td>Cantidad Autorizada: <br><b id="cautorizada"></b></td>
...
<script>
    $(document).ready(function() { 
        ...
        $.ajax({
            ...
            url: "<?=base_url()?>Apoyos/loadListadoJson",
